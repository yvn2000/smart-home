...
export default function PetScreen2() {
  ...
  const [eyesClosed, closeEyes] = useState(false);
        ...
        <ScrollView>
          <View style={{padding:10, justifyContent: 'center', alignItems: 'center',}}>
            ...
            <View style={styles.container}>
                ...
                {/* Red Screen */}
                { moodStates.death && (<Image style={[styles.redScreen, {display:'none'}]} source={require('../assets/CatAssets/Gun/redscreen.png')} /> )}
            </View>
