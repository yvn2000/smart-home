...
export default function Rewards({ rewards, updateRewardStatus }) {
    ...
    const maxXP = 100;
    const [xpGained, setXP] = useState((5 / 100) * maxXP)
    ...
    }, [xpGained, windowDimensions.width]);
    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                {/*
                <TouchableOpacity
                    style={{ height: 20, width: 50, position: 'absolute', bottom: 0, left: 0, backgroundColor: 'gray', alignItems: 'center' }}
                    onPress={() => (xpGained - 5 < ((5 / 100) * maxXP)) ? setXP(((5 / 100) * maxXP)) : addXP(-5)}
                >
                    <Text style={{ color: 'white' }}>-5</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={{ height: 20, width: 50, position: 'absolute', bottom: 0, left: 60, backgroundColor: 'gray', alignItems: 'center' }}
                    onPress={() => (xpGained + 5 > maxXP) ? setXP(maxXP) : addXP(+5)}
                >
                    <Text style={{ color: 'white' }}>+5</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={{ height: 20, width: 50, position: 'absolute', bottom: 0, left: 120, backgroundColor: 'gray', alignItems: 'center' }}
                    onPress={() => addXP(Math.sign(xpGained) == 1 ? -1 * xpGained + (5 / 100) * maxXP : xpGained + (5 / 100) * maxXP)}
                >
                    <Text style={{ color: 'white' }}>Reset</Text>
                </TouchableOpacity>
                <TouchableOpacity
                    style={{ height: 20, width: 50, position: 'absolute', bottom: 0, left: 180, backgroundColor: 'gray', alignItems: 'center' }}
                ...
                */}
                ...
                <View style={[styles.progressBar, { justifyContent: 'center' }]}>
                    ...
                    <Animated.View style={[styles.progressLevel, animatedSlideStyle, { justifyContent: 'flex-end', width: `${(xpGained / maxXP) * 100}%` }]}>
