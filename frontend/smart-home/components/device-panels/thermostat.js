...
export default function ThermoPanel({ device }) {     //width is percentage
    ...
    return (
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 50 }}>
            ...
            <TempDial device_id={device.device_id} deviceName={device.name} changeable={device.logo == 'thermostat' ? true : false} tempArg={device.temp} />

            <View style={[styles.shadow, { backgroundColor: 'white', borderRadius: 50, padding: 30, alignItems: 'center' }]}>

                <Text style={{ fontSize: 25, fontWeight: 'bold', marginBottom: 10, marginTop: 30, color: 'rgb(165, 165, 165)' }}>Humidity Level</Text>
                ...
                <View
                    ...
                    >
                        <MaterialCommunityIcons name="weather-cloudy" size={70} color="white"
                        />
                        {/*<Text style={{fontSize: 15, fontWeight: 'bold', color: 'white' }}>Fan</Text>*/}
                        <Text style={{ marginLeft: 10, marginRight: 30, fontSize: 30, fontWeight: 'bold', color: 'white' }}>{"Moderate"}</Text>
                    </LinearGradient>
                ...
                <Text style={{ fontSize: 25, fontWeight: 'bold', marginBottom: 10, marginTop: 40, color: 'rgb(165, 165, 165)' }}>Fan</Text>
